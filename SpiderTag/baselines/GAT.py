...
class FC(pl.LightningModule):
    ...
    def __init__(self, graph ,matrix, alpha , eps):
        ...
        self.conv1 = GATConv(128, 75, heads=8, concat=False)
        self.conv1.lin_edge = torch.nn.Linear(1, 32)
        self.conv2 = GATConv(75, 50, heads=8, concat=False)
        self.conv2.lin_edge = torch.nn.Linear(32, 1)
